...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ url('public/asset/plugins/fontawesome-free/css/all.min.css') }}">
  <!-- Theme style -->
...
<!-- jQuery -->
<script src="{{ url('public/asset/plugins/jquery/jquery.min.js') }}"></script>
<!-- Bootstrap 4 -->
<script src="{{ url('public/asset/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<!-- AdminLTE App -->
